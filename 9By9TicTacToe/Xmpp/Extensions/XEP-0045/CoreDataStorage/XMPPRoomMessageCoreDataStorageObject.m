...
//- (void)setCommentDetailStr:(NSString *)commentDetailStr
//{
//	[self willChangeValueForKey:@"commentDetailStr"];
//	
//	self.commentDetailStr = commentDetailStr;
//	
//	[self didChangeValueForKey:@"commentDetailStr"];
//}
//
//- (void)setCommentStr:(NSString *)commentStr
//{
//    [self willChangeValueForKey:@"commentStr"];
//	
//	self.commentStr = commentStr;
//	
//	[self didChangeValueForKey:@"commentStr"];
//}
//
//- (void)setQuestionStr:(NSString *)questionStr
//{
//    [self willChangeValueForKey:@"questionStr"];
//	
//	self.questionStr = questionStr;
//	
//	[self didChangeValueForKey:@"questionStr"];
//}
//
//- (void)setAnswerStr:(NSString *)answerStr
//{
//    [self willChangeValueForKey:@"answerStr"];
//	
//	self.answerStr = answerStr;
//	
//	[self didChangeValueForKey:@"answerStr"];
//}
