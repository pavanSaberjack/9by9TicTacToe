 ...
 * @param node
 *
 *     The name of the node to retrive message for.
 *
 *
 * @return uuid
 *
 ...
 * The server's response to the request will be reported via the appropriate delegate methods.
 *
 * @see xmppPubSub:didReceivePreviousItemsForNode:withResult:
 * @see xmppPubSub:didNotReceivePreviousItemsForNode:withResult:
 **/
